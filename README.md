...
C#/.NET, React, ilişkisel veritabanları ve full-stack web geliştirme alanlarında kendimi geliştiriyorum. Web ve mobil uygulama projeleri geliştiriyor, öğrendiğim teknolojileri gerçek projeler üzerinde uygulamaya çalışıyorum.
...
### 💻 Çalıştığım / Deneyimlediğim Teknolojiler
...
|---|---|---|---|
| 🏢 **OmegaERP** | Satış, satın alma, stok ve cari hesap süreçlerini yöneten full-stack Mini ERP. | C#, ASP.NET Core, React, SQL Server, PostgreSQL | [GitHub](https://github.com/Firdevs64/OmegaERP) • [Canlı Demo](https://omega-erp-sigma.vercel.app) |
| 📚 **DersPusulam** 🚧 | Öğrenci ders planlama, çalışma takibi ve Pomodoro mobil uygulaması. | Flutter, Dart, SharedPreferences | [GitHub](https://github.com/Firdevs64/DersPusulam) |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Firdevs_Köse-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/firdevs-kose/)
[![Medium](https://img.shields.io/badge/Medium-@firdevs6452-000000?style=for-the-badge&logo=medium&logoColor=white)](https://medium.com/@firdevs6452)
[![GitHub](https://img.shields.io/badge/GitHub-Firdevs64-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Firdevs64)
